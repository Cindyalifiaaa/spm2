...
<body>
	<div id="bungkus">
		...
		<div class="konten">
			<h4>Data SPM Berat Bayi Lahir</h4>
			<?php
			$query = "SELECT * FROM tb_bbl";
			...
			<table border="1">
				...
				<?php
				foreach ($result as $bbl) {

					?>
					<tr>
						<td><?php echo $bbl['asembagus'];?></td>
						<td><?php echo $bbl['gudang'];?></td>
						<td><?php echo $bbl['wringin'];?></td>
						<td><?php echo $bbl['trigonco'];?></td>
						<td><?php echo $bbl['perante'];?></td>
						<td><?php echo $bbl['awar'];?></td>
						<td><?php echo $bbl['kedunglo'];?></td>
						<td><?php echo $bbl['bantal'];?></td>
						<td><?php echo $bbl['kertosari'];?></td>
						<td><?php echo $bbl['mojosari'];?></td>
						<td><?php echo $bbl['pkm_induk'];?></td>
						<td><?php echo $bbl['luar_wilayah'];?></td>
						<td><?php echo $bbl['bulan'];?></td>
						<td><a href="edit_bbl.php?id=<?php echo $bbl['id'];?>">Edit</a></td>
					</tr>
				<?php } ?>
			</table>

			<?php
			$query2 = "SELECT SUM(asembagus) AS jml_asembagus,SUM(gudang) AS jml_gudang,SUM(wringin) AS jml_wringin,SUM(trigonco) AS jml_trigonco,SUM(perante) AS jml_perante,SUM(awar) AS jml_awar,SUM(kedunglo) AS jml_kedunglo,SUM(bantal) AS jml_bantal,SUM(kertosari) AS jml_kertosari,SUM(mojosari) AS jml_mojosari,SUM(pkm_induk) AS jml_pkm_induk,SUM(luar_wilayah) AS jml_luar_wilayah,SUM(luar_wilayah) AS jml_luar_wilayah FROM tb_bbl WHERE id BETWEEN '1' AND '3'";
			...
			if ($jml_data == 0) {
				...
				foreach ($result2 as $jml_bbl) {
					$jml_asembagus = $jml_bbl['jml_asembagus'];
					$jml_gudang = $jml_bbl['jml_gudang'];
					$jml_wringin = $jml_bbl['jml_wringin'];
					$jml_trigonco = $jml_bbl['jml_trigonco'];
					$jml_perante = $jml_bbl['jml_perante'];
					$jml_awar = $jml_bbl['jml_awar'];
					$jml_kedunglo = $jml_bbl['jml_kedunglo'];
					$jml_bantal = $jml_bbl['jml_bantal'];
					$jml_kertosari = $jml_bbl['jml_kertosari'];
					$jml_mojosari = $jml_bbl['jml_mojosari'];
					$jml_pkm_induk = $jml_bbl['jml_pkm_induk'];
					$jml_luar_wilayah = $jml_bbl['jml_luar_wilayah'];
				}
			}

			// batas data
			$query3 = "SELECT SUM(asembagus) AS jml_asembagus,SUM(gudang) AS jml_gudang,SUM(wringin) AS jml_wringin,SUM(trigonco) AS jml_trigonco,SUM(perante) AS jml_perante,SUM(awar) AS jml_awar,SUM(kedunglo) AS jml_kedunglo,SUM(bantal) AS jml_bantal,SUM(kertosari) AS jml_kertosari,SUM(mojosari) AS jml_mojosari,SUM(pkm_induk) AS jml_pkm_induk,SUM(luar_wilayah) AS jml_luar_wilayah,SUM(luar_wilayah) AS jml_luar_wilayah FROM tb_bbl WHERE id BETWEEN '4' AND '6'";
			...
			if ($jml_data2 == 0) {
				...
				foreach ($result3 as $jml_bbl2) {
					$jml_asembagus2 = $jml_bbl2['jml_asembagus'];
					$jml_gudang2 = $jml_bbl2['jml_gudang'];
					$jml_wringin2 = $jml_bbl2['jml_wringin'];
					$jml_trigonco2 = $jml_bbl2['jml_trigonco'];
					$jml_perante2 = $jml_bbl2['jml_perante'];
					$jml_awar2 = $jml_bbl2['jml_awar'];
					$jml_kedunglo2 = $jml_bbl2['jml_kedunglo'];
					$jml_bantal2 = $jml_bbl2['jml_bantal'];
					$jml_kertosari2 = $jml_bbl2['jml_kertosari'];
					$jml_mojosari2 = $jml_bbl2['jml_mojosari'];
					$jml_pkm_induk2 = $jml_bbl2['jml_pkm_induk'];
					$jml_luar_wilayah2 = $jml_bbl2['jml_luar_wilayah'];
				}
			}

			// batas data
			$query4 = "SELECT SUM(asembagus) AS jml_asembagus,SUM(gudang) AS jml_gudang,SUM(wringin) AS jml_wringin,SUM(trigonco) AS jml_trigonco,SUM(perante) AS jml_perante,SUM(awar) AS jml_awar,SUM(kedunglo) AS jml_kedunglo,SUM(bantal) AS jml_bantal,SUM(kertosari) AS jml_kertosari,SUM(mojosari) AS jml_mojosari,SUM(pkm_induk) AS jml_pkm_induk,SUM(luar_wilayah) AS jml_luar_wilayah,SUM(luar_wilayah) AS jml_luar_wilayah FROM tb_bbl WHERE id BETWEEN '7' AND '9'";
			...
			if ($jml_data3 == 0) {
				...
				foreach ($result4 as $jml_bbl3) {
					$jml_asembagus3 = $jml_bbl3['jml_asembagus'];
					$jml_gudang3 = $jml_bbl3['jml_gudang'];
					$jml_wringin3 = $jml_bbl3['jml_wringin'];
					$jml_trigonco3 = $jml_bbl3['jml_trigonco'];
					$jml_perante3 = $jml_bbl3['jml_perante'];
					$jml_awar3 = $jml_bbl3['jml_awar'];
					$jml_kedunglo3 = $jml_bbl3['jml_kedunglo'];
					$jml_bantal3 = $jml_bbl3['jml_bantal'];
					$jml_kertosari3 = $jml_bbl3['jml_kertosari'];
					$jml_mojosari3 = $jml_bbl3['jml_mojosari'];
					$jml_pkm_induk3 = $jml_bbl3['jml_pkm_induk'];
					$jml_luar_wilayah3 = $jml_bbl3['jml_luar_wilayah'];
				}
			}

			// batas data
			$query5 = "SELECT SUM(asembagus) AS jml_asembagus,SUM(gudang) AS jml_gudang,SUM(wringin) AS jml_wringin,SUM(trigonco) AS jml_trigonco,SUM(perante) AS jml_perante,SUM(awar) AS jml_awar,SUM(kedunglo) AS jml_kedunglo,SUM(bantal) AS jml_bantal,SUM(kertosari) AS jml_kertosari,SUM(mojosari) AS jml_mojosari,SUM(pkm_induk) AS jml_pkm_induk,SUM(luar_wilayah) AS jml_luar_wilayah,SUM(luar_wilayah) AS jml_luar_wilayah FROM tb_bbl WHERE id BETWEEN '10' AND '12'";
			...
			if ($jml_data4 == 0) {
				...
				foreach ($result5 as $jml_bbl4) {
					$jml_asembagus4 = $jml_bbl4['jml_asembagus'];
					$jml_gudang4 = $jml_bbl4['jml_gudang'];
					$jml_wringin4 = $jml_bbl4['jml_wringin'];
					$jml_trigonco4 = $jml_bbl4['jml_trigonco'];
					$jml_perante4 = $jml_bbl4['jml_perante'];
					$jml_awar4 = $jml_bbl4['jml_awar'];
					$jml_kedunglo4 = $jml_bbl4['jml_kedunglo'];
					$jml_bantal4 = $jml_bbl4['jml_bantal'];
					$jml_kertosari4 = $jml_bbl4['jml_kertosari'];
					$jml_mojosari4 = $jml_bbl4['jml_mojosari'];
					$jml_pkm_induk4 = $jml_bbl4['jml_pkm_induk'];
					$jml_luar_wilayah4 = $jml_bbl4['jml_luar_wilayah'];
				}
			}
