...
<body>
	<div id="bungkus">
		...
		<div class="konten edit-bulin">
			<?php
			$query = "SELECT * FROM tb_bumil WHERE id = $id";
			$result = mysqli_query($db,$query);

			$data = mysqli_fetch_assoc($result);

			?>
			<h4>Edit Data Bumil Bulan <?php echo ucwords($data['bulan']);?></h4>
			
			<form action="bumil_controller.php" method="POST">
