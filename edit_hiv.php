...
<body>
	<div id="bungkus">
		...
		<div class="konten edit-bulin">
			<?php
			$query = "SELECT * FROM tb_hiv WHERE id = $id";
			$result = mysqli_query($db,$query);

			$data = mysqli_fetch_assoc($result);

			?>
			<h4>Edit Data HIV Bulan <?php echo ucwords($data['bulan']);?></h4>
			
			<form action="hiv_controller.php" method="POST">
