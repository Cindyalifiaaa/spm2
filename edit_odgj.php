...
<body>
	<div id="bungkus">
		...
		<div class="konten edit-bulin">
			<?php
			$query = "SELECT * FROM tb_odgj WHERE id = $id";
			$result = mysqli_query($db,$query);

			$data = mysqli_fetch_assoc($result);

			?>
			<h4>Edit Data Odgj Bulan <?php echo ucwords($data['bulan']);?></h4>
			
			<form action="odgj_controller.php" method="POST">
