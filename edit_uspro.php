...
<body>
	<div id="bungkus">
		...
		<div class="konten edit-bulin">
			<?php
			$query = "SELECT * FROM tb_uspro WHERE id = $id";
			$result = mysqli_query($db,$query);

			$data = mysqli_fetch_assoc($result);

			?>
			<h4>Edit Data Uspro Bulan <?php echo ucwords($data['bulan']);?></h4>
			
			<form action="uspro_controller.php" method="POST">
