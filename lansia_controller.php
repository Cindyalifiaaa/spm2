...
$query = "UPDATE `tb_lansia` SET `asembagus`='$asembagus',`gudang`='$gudang',`wringin`='$wringin',`trigonco`='$trigonco',`perante`='$perante',`awar`='$awar',`kedunglo`='$kedunglo',`bantal`='$bantal',`kertosari`='$kertosari',`mojosari`='$mojosari',`pkm_induk`='$pkm_induk',`luar_wilayah`='$luar_wilayah',`bulan`='$bulan' WHERE id = '$id'";
